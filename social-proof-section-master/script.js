let resizeObserver = new ResizeObserver(() => {
    ...
    if (window.innerWidth > 1300 && document.getElementById("theme").getAttribute("href") === "styles/mobileStyle.css") {
        document.getElementById("theme").setAttribute("href", "styles/desktopStyle.css");
    }

    if (window.innerWidth <= 1300 && document.getElementById("theme").getAttribute("href") === "styles/desktopStyle.css") {
